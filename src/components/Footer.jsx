      ...
      <div className="footer-container">
        ...
        <div className="footer-bottom">
          <div className="social-links">
            ...
            <a href="https://www.instagram.com/taher._.tirar/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <p className="copyright">&copy; {currentYear} Mohamed Taher Tirar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
